    ...
    getRecord: function(req, res){
        ...
        if(!resDef){
            ...
            var record = SpuriousService.records[req.params.resource].filter(function(r){
                return r[resDef.pk] === parseInt(req.params.id);
            });
    ...
    updateRecord: function(req, res){
        ...
        if(!resDef){
            ...
            if(i === -1){
                ...
                SpuriousService.records[req.params.resource][i] = req.body;

                SpuriousService.records[req.params.resource][i][resDef.pk] = parseInt(req.params.id);
                
                res.send(SpuriousService.records[req.params.resource][i]);
            }
        }
    },
